...
path = r"C:\Users\roemb\source\repos\catkin_ws_remote\data\tada_p2\subj1\test"
    ...
    for i, start_time in enumerate(start_info['start_time']):
        ...
        for j, metric in enumerate(all_metrics): # angle_comparison, all_metrics
            ...
            for k, topic in enumerate(metric.items()):            
                ...
                figure5.add_trace(go.Scatter(x=list_of_time,y=list_of_values, mode='lines', name=metric_label,legendgroup=legend_label))
