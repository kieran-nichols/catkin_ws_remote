...
if step==0:
    ...
    for file in files:
        ...
        with open(folder+'region_motor_all.pickle', 'wb') as handle: # region_motor_all, region_angle_accurray
    ...
    for file in files:
        ...
        with open(folder+'region_motor_all.pickle', 'rb') as handle: # region_motor_all, region_angle_accurray
